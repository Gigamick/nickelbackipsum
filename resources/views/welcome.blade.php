    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center flex-column align-items-center">
                ...
                <p class="mt-4 tagline text-center">This is how you remind me what my design looks like with copy.</p>
            </div>
        </div>
        <div class="row">
